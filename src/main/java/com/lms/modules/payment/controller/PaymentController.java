...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<PaymentResponse>> verifyPayment(
            @Valid @RequestBody VerifyPaymentRequest request, Authentication authentication) {
        PaymentResponse payment = paymentService.verifyPayment(request, authentication.getName());
